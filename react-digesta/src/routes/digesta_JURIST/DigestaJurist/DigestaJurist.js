...
const DigestaJurist = () => {
  ...
  const jurist_info = (
    <div className={classes.main_jurist__container}>
      <div className={classes.main_jurist__info}>
        <div className={classes.main_jurist__title_group}>
          ...
          <div className={classes.pie}>
            <AuthorPieChart
              author={juristData.name}
              authorship={juristData.authorship}
            />
          </div>
        </div>
        ...
        <div className={classes.main_jurist__redirections}>
          ...
          <Link
            ...
            to={"/statystyki/jurysci/" + juristId}
          >
            <span>Przejdź do statystyk</span>
          </Link>
        </div>
        <p className={classes.main_jurist__description}>
          {juristData.description}
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className={classes.main_jurist}>
      {openOutlet && (
        <div className={classes.main_jurist__outlet_desktop}>
          <Outlet />
        </div>
      )}
