...
const Spinner = () => {
    ...
    return (
        ...
        <svg role="img"
             ...
             className={classes.smiley} viewBox="0 0 128 128" width="128px" height="128px">
            <defs>
                <clipPath id="smiley-eyes">
                    <circle className={classes.smiley__eye1} cx="64" cy="64" r="8"
                            transform="rotate(-40,64,64) translate(0,-56)"/>
                    <circle className={classes.smiley__eye2} cx="64" cy="64" r="8"
                            transform="rotate(40,64,64) translate(0,-56)"/>
                </clipPath>
            ...
            <g strokeLinecap="round" strokeWidth="12" strokeDasharray="175.93 351.86">
                <g>
                    ...
                    <g fill="none" stroke="hsl(193,90%,50%)">
                        <circle className={classes.smiley__mouth1} cx="64" cy="64" r="56" transform="rotate(180,64,64)"/>
                        <circle className={classes.smiley__mouth2} cx="64" cy="64" r="56" transform="rotate(0,64,64)"/>
                    </g>
                </g>
