...
const MenuBar = () => {
  ...
  const [commentedParagraphiModalOpen, setCommentedParagraphiModalOpen] =
    useState(false);
  ...
  const commentedParagraphi = useSelector(
    (state) => state.auth.commentedParagraphi
  );
  ...
  return (
    <>
      {commentedParagraphiModalOpen && (
        <CommentedParagraphiModal
          commentedParagraphi={commentedParagraphi}
      ...
      <header className={classes.main_header}>
        ...
        <nav className={classes.nav__container}>
          <div>
            ...
            <a className={classes.main_header__brand} href="/">
              <img src={logo} alt="Digesta" />
            </a>
          </div>
          <nav className={classes.main_nav}>
            <ul className={classes.main_nav__items}>
              ...
              {loggedIn && (
                <li className={classes.main_nav__comments}>
                  <button onClick={commentedParagraphiOpenHandler}>
                    Skomentowane Paragrafy {commentedParagraphi.length}
                  </button>
                </li>
              )}
              ...
              <li className={digestaNav.join(" ")}>
                <Link onClick={chooseSectionHandler} to={"/digesta"}>
                  <span id="digestaNav">Digesta</span>
                </Link>
              </li>
              <li className={juristsNav.join(" ")}>
                <Link onClick={chooseSectionHandler} to={"/jurysci"}>
                  <span id="juristsNav">Juryści</span>
                </Link>
              </li>
              <li className={operaNav.join(" ")}>
                <Link onClick={chooseSectionHandler} to={"/opera"}>
                  <span id="operaNav">Prace jurystów</span>
                </Link>
              </li>
              <li className={lookUpNav.join(" ")}>
                <Link onClick={chooseSectionHandler} to={"/wyszukaj"}>
                  <span id="lookUpNav">Wyszukaj</span>{" "}
                </Link>
              </li>
