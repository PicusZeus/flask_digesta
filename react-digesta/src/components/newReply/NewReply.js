...
const NewReply = ({ onUpdate, onClose, repliedId, username }) => {
  ...
  const mutation = useMutation({
    mutationFn: ({ newComment, isPrivate, id, repliedId }) =>
      postComment({ newComment, isPrivate, id, repliedId }),
    onMutate: () => {
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries(
        ["comment", "comments", username, repliedId],
        { exact: true }
      );
    },
    onError: (e) => {
