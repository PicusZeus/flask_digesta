...
describe('DigestaTocMobileParagraphi', () => {
  test('renders the component with options', () => {
    ...
    expect(screen.getByRole('option', { name: 'Wybierz Paragraf' })).toBeInTheDocument();
    expect(screen.getByRole('option', { name: 'Paragraph 1' })).toBeInTheDocument();
    expect(screen.getByRole('option', { name: 'Paragraph 2' })).toBeInTheDocument();
  });
