...
describe('DigestaTocMobileJuristDigestaBooks', () => {
    test('renders the component with options', () => {
        ...
        render(<DigestaTocMobileJuristDigestaBooks
            books={[{id: 1, book_latin_name: 'Book 1'}, {id: 2, book_latin_name: 'Book 2'}]} author_id={1}/>);
    ...
    test('calls the dispatch function on option change', async () => {
        ...
        expect(mockDispatch).toHaveBeenCalledWith(digestaActions.setChosenBookId(2));
