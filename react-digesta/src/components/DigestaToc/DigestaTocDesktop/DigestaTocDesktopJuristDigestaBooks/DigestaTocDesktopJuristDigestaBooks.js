...
import DigestaTocDesktopJuristDigestaBook from "../DigestaTocDesktopJuristDigestaBook/DigestaTocDesktopJuristDigestaBook";
      ...
      <ul className={classes.main_toc__items}>
        {sortedBooks &&
          sortedBooks.map((book) => {
            return (
              <DigestaTocDesktopJuristDigestaBook
                key={book.id}
                book={book}
                author_id={author_id}
              />
