...
jest.mock("../DigestaTocDesktopTitulus/DigestaTocDesktopTitulus", ()=>jest.fn())

describe('DigestaTocDesktopBook', () => {
    const book = {
        id: 1,
        book_latin_name: 'Book 1',
        tituli: [{id: 1, title: 'Titulus 1'}, {id: 2, title: 'Titulus 2'}],
    };
    ...
    test('dispatches the correct action when the button is clicked', async () => {
        ...
        expect(dispatchMock).toHaveBeenCalledWith(digestaActions.setChosenBookId(null));
    });
