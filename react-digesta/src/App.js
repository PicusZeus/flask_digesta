...
import DigestaJurists, {
    loader as digestaJuristsLoader,
} from "./routes/digesta_JURIST/DigestaJurists/DigestaJurists";
import DigestaTrad, {
    loader as digestaTradLoader,
} from "./routes/digesta_TRAD/DigestaTrad";
import DigestaLookUp from "./routes/digesta_LOOKUP/DigestaLookUp";
import DigestaJurist, {
    loader as digestaJuristLoader,
} from "./routes/digesta_JURIST/DigestaJurist/DigestaJurist";
...
import DigestaLexViewer, {
    loader as digestaLexLoader,
} from "./components/DigestaLexViewer/DigestaLexViewer";
...
import DigestaOpera, {
    loader as digestaOperaLoader,
} from "./routes/digesta_OPERA/DigestaOpera";
import {QueryClient, QueryClientProvider} from "@tanstack/react-query";
import DigestaParagraphusViewerRouterWrapper, {
    loader as digestaParagraphusViewerRouterWrapper,
...
import BookStats, {
    loader as bookStatsLoader,
} from "./components/DigestaStatistics/BookStats/BookStats";
import TitulusStats, {
    loader as titulusStatsLoader,
} from "./components/DigestaStatistics/TitulusStats/TitulusStats";
...
import JuristStats, {
    loader as juristStatsLoader,
} from "./components/DigestaStatistics/JuristStats/JuristStats";
import DigestaStatsOpera, {
    loader as digestaStatsOperaLoader,
} from "./routes/digesta_STATS/DigestaStatsOpera/DigestaStatsOpera";
import OpusStats, {
    loader as opusStatsLoader,
} from "./components/DigestaStatistics/OpusStats/OpusStats";
import JuristBookStats, {
    loader as juristBookStatsLoader,
} from "./components/DigestaStatistics/JuristBookStats/JuristBookStats";
import OpusBookStats, {
    loader as opusBookStatsLoader,
} from "./components/DigestaStatistics/OpusBookStats/OpusBookStats";
...
// export const Routes = () => <MemoryRouter initialEntries={["/digesta"]}><RouterProvider router={router}/></MemoryRouter>
