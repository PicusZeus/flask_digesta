jurists = {
    ...
    "Callistratus": {
        ...
        "end": 400},
    "Celsus": {
        "bio": "Salvius Iulianus Celsus żył w I i II wieku n.e. i był jednym z najważniejszych prawników swojego czasu. Był członkiem rzymskiego senatu i pełnił ważne funkcje państwowe, takie jak prokurator czy konsul. Celsus jest uważany za jednego z najwybitniejszych prawników rzymskich i jego prace miały duży wpływ na rozwój europejskiego prawa.",
        "start": 50,
        "end": 150},
    "Florentinus": {
        "bio": "Gaius Aelius Marcianus Florentinus, który żył w III wieku n.e. Jego dzieła zostały zachowane jedynie w formie fragmentów, ale były one ważnym źródłem dla rozwijającego się w średniowieczu prawa rzymskiego. Florentinus zajmował się przede wszystkim prawem prywatnym i swoją wiedzą przyczynił się do rozwoju prawa własności, spadkowego, a także prawa zobowiązań. Jego wkład w rozwój prawa rzymskiego jest bardzo ważny i jego prace były podstawą dla dalszych prac i rozwoju prawa europejskiego.",
        "start": 200,
        "end": 300},
    "Gaius": {
        "bio": "Gaius był rzymskim prawnikiem żyjącym w II wieku n.e. Jego pełne imię to Gaius Aelius Gallus, a nazwisko rodowe nie jest znane. Był on profesorem prawa na uniwersytecie w Rzymie i napisał wiele dzieł, z których najbardziej znane to 'Institutiones', 'Commentaria in ius civile' oraz 'Ad Edictum'. Gaius jest uważany za jednego z najważniejszych rzymskich prawników i jego dzieła miały duży wpływ na rozwój prawa rzymskiego. Jego 'Institutiones' były jednym z pierwszych podręczników prawa rzymskiego i stanowiły wprowadzenie do podstawowych zasad prawa, takich jak własność, zobowiązania czy dziedziczenie. 'Commentaria in ius civile' to komentarze do prawa cywilnego rzymskiego, a 'Ad Edictum' to komentarz do edyktu pretorskiego, czyli ogłoszenia ustaleń i decyzji pretora. Jego dzieła były bardzo popularne w średniowieczu i miały duży wpływ na rozwój prawa europejskiego. Wprowadził on wiele nowych pojęć i koncepcji prawnych, które były wykorzystywane przez rzymskich prawników i które przyczyniły się do kształtowania się europejskiego prawa cywilnego.",
        "start": 100,
        "end": 200},
    "Hermogenianus": {
        "bio": "Hermogenianus to rzymski prawnik, który żył w IV wieku n.e. i był jednym z ostatnich wybitnych rzymskich prawników. Urodził się w prowincji rzymskiej, ale jego dokładne miejsce urodzenia nie jest znane. Hermogenianus był uczniem Ulpiana, jednego z najważniejszych rzymskich prawników. Napisał wiele dzieł, z których niestety większość nie przetrwała do dzisiejszych czasów. Jego dzieła odnalezione w późniejszych czasach składają się głównie z komentarzy do różnych kodeksów prawa rzymskiego. Najważniejszym dziełem Hermogenianusa jest 'Codex Hermogenianus', który był jednym z pierwszych kodeksów prawa rzymskiego. Kodeks Hermogenianusa zawierał teksty różnych dekretów, edyktów i ustaw, wydanych przez cesarzy rzymskich w okresie od III do IV wieku n.e. Kodeks ten był ważnym źródłem prawa rzymskiego, ale niestety większość jego fragmentów przepadła w ciągu wieków. Pomimo że większość dzieł Hermogenianusa nie przetrwała do naszych czasów, jego wkład w rozwój prawa rzymskiego jest znaczący. Jego prace były podstawą dla dalszego rozwoju prawa rzymskiego i wpłynęły na rozwój prawa w Europie.",
        "start": 300,
        "end": 400},
    "Iavolenus": {
        ...
        "end": 100},
    "Iulianus": {
        "bio": "Iulianus (Iulius Paulus) był rzymskim prawnikiem, który żył w II wieku n.e. i był jednym z najwybitniejszych prawników swojego czasu. Urodził się w Emossie, na terenie dzisiejszej Turcji, ale większą część swojego życia spędził w Rzymie. Iulianus został mianowany przez cesarza Hadriana na stanowisko prefekta pretorianów, ale jego kariera wojskowa była krótka i zakończyła się niepowodzeniem. Wkrótce po tym Iulianus skupił się na swojej karierze prawniczej i stał się jednym z najbardziej szanowanych prawników w Rzymie. Iulianus był także znanym nauczycielem i jego wpływ na rozwój prawa rzymskiego jest trudny do przecenienia. Jego interpretacje prawa były często przytaczane przez innych prawników i miały wpływ na rozwój różnych gałęzi prawa rzymskiego, w tym prawa cywilnego i prawa zobowiązań.",
        "start": 100,
        "end": 200
    },
    "Licinnius Rufinus": {
    ...
    "Ulpianus": {
        "bio": "Ulpianus (wł. Domitius Ulpianus) był rzymskim prawnikiem i jednym z najważniejszych przedstawicieli szkoły prawniczej zwaną szkołą Sabinianów, która działała w III wieku naszej ery. Ulpianus urodził się około 170 roku w Tyrze (dzisiejszy Liban) i zmarł w 223 roku w Rzymie. Był bliskim doradcą cesarza Aleksandra Sewera, a po jego śmierci pełnił ważną funkcję prefekta pretorianów (odpowiednik dzisiejszego ministra spraw wewnętrznych i obrony). Ulpianus napisał ponad 200 dzieł na temat prawa, z których wiele dotyczyło prawa cywilnego rzymskiego, a także prawa karnego i administracyjnego. Jego najważniejsze dzieła to Pandectae (wspólnie z Paulusem i Papinianem stworzył zbiór opisujący całe prawo rzymskie, tzw. Triumviri), Ad Sabinum (komentarze do praw sabiniańskich), Ad Edictum (komentarze do edyktów pretorów), De Officio Proconsulis (traktat na temat obowiązków prokonsula), i De Aedilitate (traktat na temat urzędu edyla). Ulpianus był jednym z najbardziej cenionych prawników swojego czasu, a jego dzieła były bardzo wpływowe i szanowane przez kolejne pokolenia prawników rzymskich. Jego twórczość wpłynęła na rozwój prawa cywilnego nie tylko w Rzymie, ale również w Europie i na całym świecie.",
        "start": 170,
        "end": 223
    },
